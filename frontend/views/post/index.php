                ...
                <? foreach ($post as $key => $value) {
                    ...
                    <div class="panel">
                        <div class="panel-body"><h3>'.$value['title'].'</h3></div>
                          ...
                          <div class="panel-body"><p style="text-align:right;"><a href="'.Yii::$app->urlManager->createUrl('post/view?id='.$value['id']).'"><button type="button" class="btn btn-success">阅读全文</button></a></p></div>
                    </div>
                    ';
                } ?>
